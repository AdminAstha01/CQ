...
o	NFTs (helmets, “land” spaceship, “pet” drones, weapons, armors)
o	NFTs will allow special access (exclusive dungeons, exclusive emotes)
o	CQ’s NFT is interoperability to other Astha Studios’ titles.
...
o	Special Items & NFTs Purchase.
o	Withdraw ONLY by reputation.
•	NFT items with random traits
o	Rare traits = high price NFT
•	Interoperability NFTs
o	can be used at other Astha titles (MM, PLKR, future titles)
•	Decentralized Autonomous Organization (DAO) opportunity.
o	Big $TOKEN holder can decide the game’s next big features.
...
o	Blockpunk: Focuses on close range combat, they use different melee weapons to deal greater damage while risking their HP. Good as Tank type character.
o	Sharpeye: Guns afficionado, experts in multiple types of guns. They attack enemies from distances and with some good armor, they can handle some damage as their HP lower compared to the Blockpunks.
o	Webmancer: Master of cyberware and able to create massive damage while they hacked through their enemies’ tech. They are very weak when face straight on by their enemies and has the lowest HP rate.
o	Nethiver: A cyberpunk doctors who are good in fixing tech and cyberware implant alike. Their knowledge in fixing things makes them great at healing and support skills that help other job classes.
...
•	Settings:
o	Gameplay: Customize language, minimap rotation, camera inversion, notifications, and sensitivity.
o	Graphic: Adjust between 2D/3D interfaces, graphic quality, FPS limit, and display resolution.
o	Audio: Toggle music and sound effects on/off.
•	Social: Add friends and form groups.
•	Pet: Purchase pets and utilize them in both city commuting and battles.
•	Inventory:
o	Equipment: Change costumes and weapons.
o	Potion: Utilize potions for various battle boosts.
o	Item: Manage gems, usable, and more.
o	Chip: Enhance battle capabilities.
o	Food: Contains pet food and plants.
...
o	Subway Station: Instantly transport to other locations, including different bases and hunting areas.
o	BHG: A Bounty Hunter Guild that sells weapons & armor.
o	Governor of CQ: Unlock a second class and embark on additional quests.
...
a.	The Player will first need to download the game from the GooglePlay, Appstore or designated app store.
b.	After downloading the game, the player then sets up their account and gets their OTP from their registered email address.
c.	The loading screen while the game is downloading will show environment like in cyberpunk airport immigration. It shows the counter window where the immigration officer usually posted is, but the window is still closed with the roll blinds and notes “Be back after Lunch!”.
d.	Once the download process is completed, the counter window suddenly opens, and an attractive cyberpunk immigration lady officer asked to move forward.
e.	The cyberpunk immigration officer then asked the player to take a picture where at this phase, the player can decide their avatar looks inside the game and job class that they want to pick.
f.	After the player decides their avatar looks and job class, a cutscene showing the lady immigration officer acknowledges that the player is another new bounty hunter in the city of New Jakarta.
g.	She then provides C.H.A.I.N (Computerized Henshin Applicator Interoperability Neckwear), D.O.P.E (Dimensional Ordinance Pocket Entrapment) and B.L.A.S.T (Bounty List Assistant Secure Tracker) to the player’s character.
h.	The Player’s character then enters the city of New Jakarta for the first time and the B.L.A.S.T will then inform the player to check the bounty hunter board to start checking the criminal list in front of CQPD.
i.	The Player will be asked to pick a novice criminal for his/her tutorial phase.
j.	After selecting the criminal, B.L.A.S.T will inform the player to visit BHG and once the player reaches & gets inside the guild, the cute lady behind the weapon counter will then offer the player a beginner weapon.
k.	After the player has their equipment with them, the player will then be asked to go to the nearest subway ticket machine to be transported to a tutorial area where they will start their first hunt.
l.	At the tutorial area, the player will then need to defeat several small enemies in the area first, before the boss (criminal that they player hunt) will appear.
m.	Once the boss is defeated, the player will use their D.O.P.E to capture the criminal.
n.	The Player then needs to get back to the bounty hunter board list at CQPD where they put their D.O.P.E inside the machine and in return, they’ll get their bounty hunting reward.
o.	And after that, the player can start hunting other new criminals from the bounty hunter board again and upgrade their equipment along the way at the BHG.
...
Economy Policy
Notes to Andre or Mickey: Please update this part as you see fit.
 
Astha Studio Team
